...
import com.mchediek.logisis.controller.GestorDeViajesLocal;
...
public class Main {
	private static final GestorDeViajes gestorDeViajes = new GestorDeViajesLocal();
	...
	private static Conductor crearConductor() {
        ...
        return new Conductor(gestorDeViajes.listarViajes().size() + 1, nombreConductor, licenciaConductor);
	}
	...
	private static Cliente CrearCliente() {
        ...
        return new Cliente(gestorDeViajes.listarViajes().size() + 1, nombreCliente, direccionCliente, telefonoCliente);
	}
